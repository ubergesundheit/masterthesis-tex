...
Nearly all respondents mentioned the informing of the public as useful attribute for spatial discussion platforms. The ability to gain a spatial overview of the topic (P1, P3, P7) and a sense of proximity to projects (P7, P8) were also mentioned as advantageous attributes for public deliberation. The ubiquitousness of Internet use allows the general public to engage other users in discussions (P2, P5). Displaying markers and polygons on a map also allows to easily grasp the density of projects (P7). Additionally, interactivity enables users to understand the connection between a project and its location (P4, P6). 
