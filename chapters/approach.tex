...
Creation of contributions is only allowed after a successful authentication to the system. Users can either register an user account with an e-mail password combination or authenticate themselves through third party authentication providers Twitter, Facebook or Google \cite{Sani2011_Scalable_Argumap,chun2014usability}.\\
