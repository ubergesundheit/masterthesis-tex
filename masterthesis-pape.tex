...
\section{Appendix A. Semi-Structured Interview and Focus Group Guidelines}

\begin{adjustwidth}{-8em}{-8em}
\begin{longtable}{|p{6.45cm}|p{6.45cm}|p{6.45cm}|p{6.45cm}|}
 \hline
 \textbf{Leitfrage (Erzählaufforderung)}&\textbf{Check -- Wurde das erwähnt? Memo für mögliche Nachfragen -- nur stellen wenn nicht von allein angesprochen! Formulierung anpassen}&\textbf{Konkrete Fragen - bitte an passender Stelle (auch am Ende möglich) in dieser Formulierung stellen}&\textbf{Aufrechterhaltungs- und Steuerungsfragen}\\
 \hline
 \multicolumn{4}{|l|}{Teil 1 -- Bürgerbeteiligung}\\
 \hline
 
 Erza"hlen Sie mir über ihre Rolle und Aufgaben in Bürgerbeteiligung & yolo
 
%  \begin{itemize}
%     \item Wie lange aktiv (Befragter, Projekt)
%     \item ``Organisator'' oder ``Ausführender an der Basis''
%  \end{itemize}
